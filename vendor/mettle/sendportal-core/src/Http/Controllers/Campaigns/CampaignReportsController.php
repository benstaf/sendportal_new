...
class CampaignReportsController extends Controller
{
    ...
    public function complaints(int $id)
    {
        ...
        $messages = $this->messageRepo->complaints(auth()->user()->currentWorkspace()->id, Campaign::class, $id);

        return view('sendportal::campaigns.reports.complaints', compact('campaign', 'messages'));
    }
