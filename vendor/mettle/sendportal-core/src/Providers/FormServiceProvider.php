...
class FormServiceProvider extends ServiceProvider
{
	...
	Form::macro('selectMultiplesearchField', function ($name, $label = null, $options, $value = null, $attributes = []) {
            $attributes = array_merge($attributes, ['data-live-search' => true,  'multiple' => true, 'class' => 'selectpicker']);
            $element = Form::select($name, $options, $value, Form::fieldAttributes($name, $attributes));
