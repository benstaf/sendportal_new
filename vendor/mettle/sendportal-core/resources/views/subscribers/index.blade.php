...
-->
 ...
 <a class="btn btn-light btn-md mr-2"  href="{{ route('sendportal.subscribers.import') }}">
                        <i class="fa fa-upload color-gray-400 mr-1"></i> {{ __('Import Subscribers') }}
                    </a>
                    <a class="btn btn-light btn-md mr-2"  href="{{ route('sendportal.subscribers.export') }}" 
   onclick="return confirm('Are you sure you want to export subscribers?')">
                        <i class="fa fa-download color-gray-400 mr-1"></i> {{ __('Export Subscribers') }}
                    </a>
