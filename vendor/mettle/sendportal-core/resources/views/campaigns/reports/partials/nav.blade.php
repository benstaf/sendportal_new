<ul class="nav nav-pills mb-3">
   ...
   <li class="nav-item">
        <a class="nav-link {{ request()->route()->named('sendportal.campaigns.reports.complaints') ? 'active'  : '' }}"
           href="{{ route('sendportal.campaigns.reports.complaints', $campaign->id) }}">{{ __('Complaints') }}</a>
    </li>
</ul>
